import { openBlock, createBlock, renderSlot, createVNode, withKeys, withModifiers, mergeProps, Fragment, renderList, createCommentVNode, toDisplayString, toRef, computed, isRef, isReactive, ref, getCurrentInstance, watch, nextTick, onMounted, watchEffect, provide, resolveComponent, withCtx, withDirectives, vShow, onUpdated, inject, withScopeId } from 'vue';
...
C.render = function (e, n, l, d, c, p) {
  return openBlock(), createBlock("div", T, [renderSlot(e.$slots, "prepend"), createVNode("input", {
    ref: "input",
    ...
    onKeyup: n[5] || (n[5] = withKeys(withModifiers(function () {
      return d.handleEscape && d.handleEscape.apply(d, arguments);
    }, ["exact"]), ["esc"])),
    tabindex: l.tabindex,
    autofocus: l.autofocus
  }, null, 40, ["modelValue", "placeholder", "disabled", "tabindex", "autofocus"]), renderSlot(e.$slots, "append")]);
...
D.render = function (e, n, l, r, d, h) {
  return openBlock(), createBlock("ul", mergeProps({
    ...
    onMousedown: n[1] || (n[1] = withModifiers(function () {}, ["prevent"])),
    tabindex: "-1",
    onClick: n[2] || (n[2] = function () {
      return r.handleClick && r.handleClick.apply(r, arguments);
    })
  }, r.dataAttrs), [(openBlock(!0), createBlock(Fragment, null, renderList(l.modelValue, function (n) {
    return openBlock(), createBlock(Fragment, {
      key: n.key
    }, [n.group ? createCommentVNode("v-if", !0) : (openBlock(), createBlock("li", {
      key: 0,
      class: ["vue-tag", {
        selected: n.selected
      }]
      ...
      return [createVNode("span", null, toDisplayString(n.label), 1)];
    })], 2))], 64);
  }), 128))], 16);
...
var N = {
  ...
  setup: function (e, n) {
    return {
      dataAttrs: inject("dataAttrs"),
      handleClickItem: function (e, l) {
        l.disabled || n.emit("click-item", e, l);
      },
      handleMousemove: function (e, l) {
...
N.render = function (e, n, l, r, d, h) {
  return openBlock(), createBlock("ul", mergeProps({
    ...
    return openBlock(), createBlock(Fragment, {
      key: n.key
    }, [n.visible && !1 === n.hidden ? (openBlock(), createBlock("li", {
      key: 0,
      onClick: function (e) {
      ...
      return [createVNode("span", null, toDisplayString(n.label), 1)];
    })], 42, ["onClick", "onMousemove"])) : createCommentVNode("v-if", !0)], 64);
  }), 128))], 16);
}, N.__file = "src/components/dropdown.vue";

var E = function (e, n, l) {
  var t = l.valueBy;
  return t(e) === t(n);
},
    L = function (e, n, l) {
  ...
  setup: function (l, t) {
    var u = function (n) {
      return {
        labelBy: _(toRef(n, "labelBy")),
        valueBy: _(toRef(n, "valueBy")),
        disabledBy: _(toRef(n, "disabledBy")),
        groupBy: _(toRef(n, "groupBy")),
        ...
        options: isRef(n.options) || isReactive(n.options) ? toRef(n, "options") : ref(n.options)
      };
    }(l),
        a = u.labelBy,
        o = u.valueBy,
    ...
    var G = function (e, n) {
      ...
      var l = function (l) {
        var u = e.value.find(function (e) {
          return e.originalIndex === l;
        });
        return void 0 !== u && !1 !== t(u) && (n.value = l, !0);
      },
          t = function (e) {
      ...
      return watchEffect(function () {
        ...
        pointerForward: function () {
          if (!1 !== u.value && null !== n.value) for (var t = n.value + 1; t !== n.value && (e.value.length <= t && (t = 0), !l(t));) ++t;
        },
        pointerBackward: function () {
          if (!1 !== u.value && null !== n.value) for (var t = n.value - 1; t !== n.value && (t < 0 && (t = e.value.length - 1), !l(t));) --t;
        },
        pointerSet: l
      };
    }(X, J),
      ...
      if (n && v.value) {
        for (var l = getComputedStyle(n); n.offsetTop + parseFloat(l.height) + parseFloat(l.paddingTop) + parseFloat(l.paddingBottom) > v.value.$el.clientHeight + v.value.$el.scrollTop;) v.value.$el.scrollTop = v.value.$el.scrollTop + parseFloat(l.height) + parseFloat(l.paddingTop) + parseFloat(l.paddingBottom);

        for (; n.offsetTop < v.value.$el.scrollTop;) v.value.$el.scrollTop = v.value.$el.scrollTop - parseFloat(l.height) - parseFloat(l.paddingTop) - parseFloat(l.paddingBottom);
      }
    },
    ...
    return {
      ...
      pointerForward: function () {
        ne.apply(void 0, arguments), nextTick(ue);
      },
      pointerBackward: function () {
        le.apply(void 0, arguments), nextTick(ue);
      },
      pointerSet: te
    };
  },
  ...
  class: "icon loading"
    ...
    R = createVNode("div", null, null, -1),
    U = createVNode("div", null, null, -1),
    H = createVNode("div", null, null, -1),
    G = {
  class: "icon loading"
},
    Q = createVNode("div", null, null, -1),
    Y = createVNode("div", null, null, -1),
    K = createVNode("div", null, null, -1);

P.render = function (e, n, l, d, s, h) {
  var g = resolveComponent("v-tags"),
      y = resolveComponent("v-input"),
      m = resolveComponent("v-dropdown");
  return openBlock(), createBlock("div", mergeProps({
    ...
    onKeypress: n[12] || (n[12] = withKeys(function () {
      return null !== e.highlightedOriginalIndex && e.addOrRemoveOption(e.$event, e.optionsWithInfo[e.highlightedOriginalIndex]);
    }, ["enter"])),
    onKeydown: [n[13] || (n[13] = withKeys(withModifiers(function () {
      return e.pointerForward && e.pointerForward.apply(e, arguments);
    }, ["prevent"]), ["down"])), n[14] || (n[14] = withKeys(withModifiers(function () {
      return e.pointerBackward && e.pointerBackward.apply(e, arguments);
    }, ["prevent"]), ["up"]))]
  }), [createVNode("div", Z, [e.multiple && e.taggable && 0 === e.modelValue.length || !1 === e.searchable && !1 === e.taggable ? (openBlock(), createBlock("div", W, [createVNode("input", {
    placeholder: e.innerPlaceholder,
    readonly: "",
    onClick: n[1] || (n[1] = function () {
      return e.focus && e.focus.apply(e, arguments);
    })
  }, null, 8, ["placeholder"])])) : createCommentVNode("v-if", !0), e.multiple && e.taggable ? (openBlock(), createBlock(Fragment, {
    key: 1
  }, [createVNode(g, {
    ...
    default: withCtx(function (n) {
      var l = n.option;
      return [renderSlot(e.$slots, "tag", {
        option: l.originalOption
      }, function () {
        return [createVNode("span", null, toDisplayString(l.label), 1), createVNode("img", {
    ...
    _: 1
  }, 8, ["modelValue", "collapse-tags", "onClick"]), createVNode("span", {
    ...
    onMousedown: n[3] || (n[3] = withModifiers(function () {}, ["prevent", "stop"]))
  }, null, 34)], 64)) : (openBlock(), createBlock(Fragment, {
    key: 2
  }, [e.searchable ? (openBlock(), createBlock(y, {
    key: 0,
    ref: "input",
    ...
    tabindex: e.tabindex
  }, null, 8, ["modelValue", "disabled", "placeholder", "onInput", "onChange", "onFocus", "onBlur", "onEscape", "autofocus", "tabindex"])) : createCommentVNode("v-if", !0), withDirectives(createVNode("span", q, [R, U, H], 512), [[vShow, e.loading]]), withDirectives(createVNode("span", {
    class: ["icon arrow-downward", {
      active: e.isFocusing
    }],
    ...
    onMousedown: n[6] || (n[6] = withModifiers(function () {}, ["prevent", "stop"]))
  }, null, 34), [[vShow, !1 === e.loading]])], 64))], 512), e.multiple && e.taggable && e.searchable ? withDirectives((openBlock(), createBlock(y, {
    key: 0,
    ref: "input",
    modelValue: e.searchingInputValue,
    ...
    append: withCtx(function () {
      return [withDirectives(createVNode("span", G, [Q, Y, K], 512), [[vShow, e.loading]])];
    }),
    _: 1
  }, 8, ["modelValue", "disabled", "placeholder", "onInput", "onChange", "onFocus", "onBlur", "onEscape", "tabindex", "autofocus"])), [[vShow, e.isFocusing]]) : createCommentVNode("v-if", !0), withDirectives(createVNode(m, {
    ref: "dropdown",
    modelValue: e.optionsWithInfo,
    ...
    default: withCtx(function (n) {
      var l = n.option;
      return [renderSlot(e.$slots, "dropdown-item", {
        option: l.originalOption
      }, function () {
        return [createVNode("span", null, toDisplayString(l.label), 1)];
      })];
    }),
    _: 1
  }, 8, ["modelValue", "onClickItem", "header-height"]), [[vShow, e.isFocusing]])], 16, ["tabindex"]);
}, P.__file = "src/index.vue";
...
const _withId = /*#__PURE__*/withScopeId("data-v-5bfad3a6");
...
script.__scopeId = "data-v-5bfad3a6";
